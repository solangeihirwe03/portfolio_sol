...
export const Home = () => {
    return (
        <Element name="home" className='w-full px-4 pt-10 md:py-8 md:px-10 flex flex-col-reverse md:flex-row items-center jus md:gap-16 lg:px-20 min-h-screen' id="home">
